...
public class HttpResultHandler implements ResultHandler {
    private boolean prevIsNamed = false;
    ...
    private String continuationId = null;
    private String continuationLabel = null;
    private String name;
