...
public class DbResultHandler extends ResultHandler {
    ...
    {
        {
            ...
            dbConn = DriverManager.getConnection("jdbc:hsqldb:file:"
                                    + commandLine_NER.getOutputDirectoryRoot().getAbsolutePath()
                                    + "/annotations", "SA", "");
    ...
    public DbResultHandler(final ContainerContext context, final String name) throws SQLException {
        ...
        if (label != null) {
            try {
                ...
                throw new IllegalStateException(
                        "Could not add new token to annotations database!",
                        error);
            }
